...
/* See: 
 * https://redmine.named-data.net/issues/1278/ 
 * https://linux.die.net/man/7/packet 
 * https://sourceforge.net/p/linuxptp/mailman/message/28972373/ 
 * https://lwn.net/Articles/789690/ 
 * https://doc.dpdk.org/api-17.05/examples_2ptpclient_2ptpclient_8c-example.html 
 * The ptp4l program calls setsockopt(IP_ADD_MEMBERSHIP), and this makes
 * the networking stack do what it needs to (eg. set the multicast
 * filter) in order to make it happen at the Ethernet level. 
 * */
